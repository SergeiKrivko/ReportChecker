...
{
    public Task<Guid> CreateReportAsync(Guid ownerId, string name, string format, string sourceProvider, Guid? llmModelId);
    public Task<bool> DeleteReportAsync(Guid reportId);
    public Task<bool> RenameReportAsync(Guid reportId, string newName, Guid? llmModelId);
