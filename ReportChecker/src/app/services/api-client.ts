...
export class ApiClient extends ApiClientBase {
     ...
     * @return OK
     */
    restart(reportId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/v1/reports/{reportId}/checks/latest/restart";
        if (reportId === undefined || reportId === null)
            throw new Error("The parameter 'reportId' must be defined.");
        url_ = url_.replace("{reportId}", encodeURIComponent("" + reportId));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    tasksPOST(reportId: string, body: CreateInstructionTaskSchema | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/v1/reports/{reportId}/instructions/tasks";
        if (reportId === undefined || reportId === null)
            throw new Error("The parameter 'reportId' must be defined.");
        url_ = url_.replace("{reportId}", encodeURIComponent("" + reportId));
    ...
    protected processTasksPOST(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    tasksDELETE(reportId: string, taskId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/v1/reports/{reportId}/instructions/tasks/{taskId}";
        if (reportId === undefined || reportId === null)
            throw new Error("The parameter 'reportId' must be defined.");
        url_ = url_.replace("{reportId}", encodeURIComponent("" + reportId));
